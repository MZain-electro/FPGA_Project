...
template <int OC, int IC, int KH, int KW>
void load_4d_weights(const char *filename, data_t tensor[OC][IC][KH][KW])
{
    std::ifstream file(filename, std::ios::binary);
    if (!file)
    {
    ...
    file.read(reinterpret_cast<char *>(tensor), sizeof(data_t) * OC * IC * KH * KW);
    file.close();
}
...
int main()
{
   ...
   // static data_t block1_output_conv1[BATCH][OUT_CHANNELS][HEIGHT / 2][WIDTH / 2];
    ...
    // Delete these temporary variables later
    // static data_t avgpool_output_reference[BATCH][OUT_CHANNELS];
    // static data_t block0_output_reference[BATCH][OUT_CHANNELS][HEIGHT/2][WIDTH/2];
    ...
    load_4d_input<BATCH, IN_CHANNELS, HEIGHT, WIDTH>("input_1.bin", input_local);
    std::cout << "Input 2 loaded!" << std::endl;
    // weights for conv1 block0
    load_4d_weights<OUT_CHANNELS, IN_CHANNELS, KERNEL_HEIGHT, KERNEL_WIDTH>("layer4_block0_conv1_weights.bin", block0_weights_conv1);
    ...
    load_4d_weights<OUT_CHANNELS, OUT_CHANNELS, KERNEL_HEIGHT, KERNEL_WIDTH>("layer4_block0_conv2_weights.bin", block0_weights_conv2);
    ...
    load_4d_weights<OUT_CHANNELS, IN_CHANNELS, DS_KERNEL_HEIGHT, DS_KERNEL_WIDTH>("layer4_block0_downsample_weights.bin", block0_weights_ds_conv1);
    ...
    load_4d_weights<OUT_CHANNELS, OUT_CHANNELS, KERNEL_HEIGHT, KERNEL_WIDTH>("layer4_block1_conv1_weights.bin", block1_weights_conv1);
    ...
    load_4d_weights<OUT_CHANNELS, OUT_CHANNELS, KERNEL_HEIGHT, KERNEL_WIDTH>("layer4_block1_conv2_weights.bin", block1_weights_conv2);
    ...
    load_4d_weights<BATCH, OUT_CHANNELS, HEIGHT / 2, WIDTH / 2>("block0_output.bin", block0_bn1_output_reference);
    ...
    ResNet(input, block0_weights_conv1, 
           ...
           block0_weights_conv2, block0_gamma2, block0_beta2, block0_mean2, block0_var2, block0_output_bn2, input_local, output_local,
